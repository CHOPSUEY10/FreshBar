    ...
    <style>
        * {
        ...
        .swipe-layer {
            position: fixed;
            inset: 0;
            background: linear-gradient(135deg, #0f9f95, #08746d);
            transform: translateY(100%);
            animation: loginSwipeUp 1.15s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        ...
        .soft-circle.one {
            ...
            top: -110px;
            right: -80px;
            animation: circleFloatOne 1.15s ease forwards;
        }
        ...
        .soft-circle.two {
            ...
            bottom: -70px;
            left: -60px;
            animation: circleFloatTwo 1.15s ease forwards;
        }
        ...
        .minimal-loader {
            ...
            opacity: 0;
            animation: loaderUp 0.95s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        ...
        .small-dot.dot-one {
            top: 24%;
            left: 18%;
            animation: dotUp 1.1s ease forwards;
        }
...
<body>
    ...
    <script>
        setTimeout(function () {
            window.location.href = <?= json_encode($redirectUrl ?? site_url('dashboard')) ?>;
        }, 1150);
    </script>
</body>
</html>